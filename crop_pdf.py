...
if __name__ == '__main__':
    ...
    pymusco.crop_pdf(src_scanned_pdf_file_path='/Users/graffy/data/Perso/MeltingNotes_work.git/partitions/scans/194-atlantis-piccolo-scan-brut.pdf', dst_scanned_pdf_file_path='/Users/graffy/data/Perso/MeltingNotes_work.git/partitions/scans/194-atlantis-piccolo.pdf', x_scale=x_scale, y_scale=y_scale)
